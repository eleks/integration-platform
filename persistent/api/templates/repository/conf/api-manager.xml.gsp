<APIManager>
    ...
    <AuthManager>
        ...
        <ServerURL>https://<%= role.host %>:<%= role.port.mhttps %>${carbon.context}services/</ServerURL>
    ...
    <APIGateway>
        ...
        <Environments>
            ...
            <Environment type="hybrid" api-console="true">
                ...
                <GatewayEndpoint>http://<%= role.host %>:<%= role.port.http %>,https://<%= role.host %>:<%= role.port.https %></GatewayEndpoint>
    ...
    <Analytics>
        ...
        <StreamProcessorServerURL>{tcp://<%= roles.apxw.service %>:7612}</StreamProcessorServerURL>
        ...
        <StreamProcessorRestApiURL>https://<%= roles.apxw.service %>:7444</StreamProcessorRestApiURL>
    ...
    <OAuthConfigurations>
        ...
        <RevokeAPIURL>https://<%= role.host %>:<%= role.port.https %>/revoke</RevokeAPIURL>
    ...
    <APIStore>
        ...
        <URL>https://<%= role.host %>:<%= role.port.mhttps %>/store</URL>
    ...
    <APIPublisher>
        <DisplayURL>false</DisplayURL>
        <URL>https://<%= role.host %>:<%= role.port.mhttps %>/publisher</URL>
    ...
    <ThrottlingConfigurations>
        ...
        <PolicyDeployer>
            <Enabled>true</Enabled>
            <ServiceURL>https://<%= role.host %>:<%= role.port.mhttps %>${carbon.context}services/</ServiceURL>
            <Username>${admin.username}</Username>
            <Password>${admin.password}</Password>
        </PolicyDeployer>
        <BlockCondition>
